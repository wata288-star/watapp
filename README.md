...
- **機械カルテ** — 基本情報、機械QRコード、整備履歴タイムライン、記録充実度(A/B/C等級)の算定、証明書発行前の異常パターンチェック、査定準備状況(高インパクト項目のカバー率)
- **整備記録** — 全記録の横断検索
- **記録項目マスター** — 中古買取・査定で確認される項目の3層マスター(全機械共通20項目+機種別10機種71項目+法定記録)。記録は「写真+一言」のままキーワードで自動対応付けし、機械ごとの査定準備状況を算定(`lib/karte/master.ts`)
